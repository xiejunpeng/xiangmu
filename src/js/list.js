...
//=================================================  列表页主要功能就是分页功能跟带id到详情页  gid
            ...
            var matter1=document.querySelector('.matter1');
           	...
           	function xuanlan(arr){
           		var reg=arr.datalist.map(function(item){   //arr.datalist  得到的是获取内容部分  是一个数组织
             ...
             //二.点击切换页码
             page1.onclick=function(ev){  //事件绑在父元素身上,
             	var ev=ev || window.event;
             	if(ev.target.tagName.toLowerCase()=='span'){  //目标span  如果点击的目标是span则
